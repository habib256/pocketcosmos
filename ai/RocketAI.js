...
class RocketAI {
    ...
    subscribeToEvents() {
        ...
        this.eventBus.subscribe(window.EVENTS.AI.TOGGLE_CONTROL, () => this.toggleActive());
        ...
        this.eventBus.subscribe(window.EVENTS.ROCKET.DESTROYED, () => this.handleCrash());
