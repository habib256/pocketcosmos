...
const PHYSICS = {
    // Gravité
    G: 0.01,                // Constante gravitationnelle (Temporairement augmentée pour test: était 0.0001)
...
const ROCKET = {
    ...
    // Position initiale par défaut (si pas de corps céleste trouvé)
    INITIAL_X: 0,               // Position X initiale par défaut
    INITIAL_Y: 2160,            // Position Y initiale par défaut (3 * rayon de la Terre = 3 * 720)
    ...
    // Propulseurs - Puissance maximale (en pourcentage, 0-100)
    THRUSTER_POWER: {
        MAIN: 100,             // Puissance maximale du propulseur principal (100%)
        REAR: 80,              // Puissance maximale du propulseur arrière (80%)
        LEFT: 60,              // Puissance maximale du propulseur gauche (60%)
        RIGHT: 60              // Puissance maximale du propulseur droit (60%)
    },
...
// Exposition globale des constantes
window.PHYSICS = PHYSICS;
window.RENDER = RENDER;
window.ROCKET = ROCKET;
window.CELESTIAL_BODY = CELESTIAL_BODY;
