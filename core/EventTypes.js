...
window.EVENTS = {
  ...
  PHYSICS: {
    // Événements du moteur physique
    ENGINE_INITIALIZED: 'PHYSICS_ENGINE_INITIALIZED',
    ENGINE_STARTED: 'PHYSICS_ENGINE_STARTED',
    ENGINE_STOPPED: 'PHYSICS_ENGINE_STOPPED',
    ENGINE_UPDATED: 'PHYSICS_ENGINE_UPDATED',
    ENGINE_ERROR: 'PHYSICS_ENGINE_ERROR',
    ENGINE_RESET: 'PHYSICS_ENGINE_RESET',
    ENGINE_DESTROYED: 'PHYSICS_ENGINE_DESTROYED',
    BEFORE_UPDATE: 'PHYSICS_BEFORE_UPDATE',
    AFTER_UPDATE: 'PHYSICS_AFTER_UPDATE',
    
    // Événements des corps physiques
    BODY_ADDED: 'PHYSICS_BODY_ADDED',
    BODY_REMOVED: 'PHYSICS_BODY_REMOVED',
    BODY_MOVED: 'PHYSICS_BODY_MOVED',
    VELOCITY_CHANGED: 'PHYSICS_VELOCITY_CHANGED',
    FORCE_APPLIED: 'PHYSICS_FORCE_APPLIED',
    
    // Événements des contraintes
    CONSTRAINT_ADDED: 'PHYSICS_CONSTRAINT_ADDED',
    CONSTRAINT_REMOVED: 'PHYSICS_CONSTRAINT_REMOVED',
    
    // Événements des corps célestes
    CELESTIAL_BODIES_INITIALIZED: 'PHYSICS_CELESTIAL_BODIES_INITIALIZED',
