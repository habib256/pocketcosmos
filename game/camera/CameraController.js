...
class CameraController {
    ...
    subscribeToEvents() {
        ...
        this.eventBus.subscribe(EVENTS.CAMERA.ZOOM_IN, () => this.handleZoomIn());
        this.eventBus.subscribe(EVENTS.CAMERA.ZOOM_OUT, () => this.handleZoomOut());
        this.eventBus.subscribe(EVENTS.CAMERA.CAMERA_ZOOM_ADJUST, (data) => this.handleCameraZoomAdjust(data));
        this.eventBus.subscribe(EVENTS.CAMERA.CENTER_ON_ROCKET, () => this.handleCenterCamera());
        this.eventBus.subscribe(EVENTS.CAMERA.START_DRAG, (data) => this.handleCameraStartDrag(data));
        this.eventBus.subscribe(EVENTS.CAMERA.DRAG, (data) => this.handleCameraDrag(data));
        this.eventBus.subscribe(EVENTS.CAMERA.STOP_DRAG, () => this.handleCameraStopDrag());

        // Nouvel abonnement pour la commande de zoom générique (par exemple, depuis un joystick)
        this.eventBus.subscribe(EVENTS.INPUT.ZOOM_COMMAND, (data) => this.handleZoomCommand(data));
